...
namespace Investigation
{
    public partial class GameManager
    {
        ...
        public void ItemClicked(int selectionIdx, GameObject selectionObj)
        {
            ...
            FloatItemCTRL obj_inv_FloatItemCTRL = floatingItem.AddComponent<FloatItemCTRL>();
        ...
        public void ItemRelease(int floatingIdx)
        {
            ...
            foreach (Collider2D hit in hits)
            {
                ...
                {
                    hit.gameObject.GetComponent<InteractionObj>().InventoryItemDraggedOn(floatingItemName);
                }
                else if(hit.gameObject.tag == "Player")
                {
                    hit.gameObject.GetComponent<PlayerCTRL>().InventoryItemDraggedOn(floatingItemName);
                }
            }
        }
