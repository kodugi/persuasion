    ...
    public partial class GameManager : Utility
    {
        ...
        GameObject staringPeople{
            get{
                ...
                {
                    _staringPeople = FindFirstObjectByType<Obj_Staring_People>().gameObject;
                }
        ...
        private IEnumerator CutSceneProgress(string title)
        {
            switch (title)
            {
                case "PeopleRunningAfterReceivingPen":
                    staringPeople.GetComponent<Obj_Staring_People>().StartRunning();
                ...
                case "PeopleStaringAfterReceivingPen":
                    ...
                    if(penPossessed && notePossessed)
                    {
                        ...
                        if (peopleStaringPrefab != null)
                        {
                            ...
                            staringPeople.GetComponent<Obj_Staring_People>().player = playerCTRL.gameObject;
                            staringPeople.GetComponent<Obj_Staring_People>().manager = this;
                            staringPeople.GetComponent<Obj_Staring_People>().house_gather = interactManager.FindInteractableObj("Map1/House_Gathering").gameObject;
                        }
                        else
                        {
                ...
                case "IntoDream":
                    ...
                    interactManager.FindInteractableObj("Map1/House_WitchMother").gameObject.GetComponent<InteractionObj>().FadeSwitch(0,1,0,0);
