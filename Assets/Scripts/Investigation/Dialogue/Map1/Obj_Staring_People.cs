...
{
public class Obj_Staring_People: Utility
    {
        ...
        private static Obj_Staring_People instance;
        ...
        void Update()
        {
            ...
            foreach(var pair in people)
            {
                ...
                if (doRun)
                {
                    ...
                    player.GetComponent<PlayerCTRL>().CanPlayerMove(false);
                }
            }
            if(cnt <= 0)
            {
                manager.ChangeCamera(player.transform, 0.1f);
                player.GetComponent<PlayerCTRL>().CanPlayerMove(true);
                Destroy(gameObject);
            }
        }
