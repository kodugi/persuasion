...
{
    public class InteractionCTRL : Utility
    {
        ...
        void Start()
        {
            ...
            manager = GameObject.FindFirstObjectByType<GameManager>().GetComponent<GameManager>();
            playerCTRL = GameObject.FindFirstObjectByType<PlayerCTRL>().GetComponent<PlayerCTRL>();
        ...
        private void InteractionGuideUpdate(string mode = "default")
        {
            ...
            if(id == null) {
                ...
                if (temp_obj.GetComponent<InteractionObj>().manuallyTouchable)
                {
        ...
        private void Interact(string name)
        {
            ...
            {
                InteractionObj interactingObj = FindInteractableObj(id).GetComponent<InteractionObj>();
            ...
            dialogueScript = obj.GetComponent<DialogueBox>();
        ...
        {
            //print("ending"+name);
            InteractionObj interactingObj = null;
            if(FindInteractableObj(name) != null) interactingObj = FindInteractableObj(name).GetComponent<InteractionObj>();
        ...
        public void Effects(JObject effect)
        {
            ...
            switch (type)
            {
                ...
                case "variation":
                    ...
                    if(FindInteractableObj(target) != null) FindInteractableObj(target).GetComponent<InteractionObj>().variation(parameters);
